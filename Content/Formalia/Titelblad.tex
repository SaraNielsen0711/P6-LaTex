...
\vspace{20 mm} % Sætter afstand fra ovenstående. Skal op eller nedjusteres, så det ser pænt ud og holder sig på én side.
...
\begin{table}[H]
	\centering
		\begin{tabular}{c c c}
			...
			\groupmemberI & \groupmemberII & \groupmemberIII\\
			&&\\
			&&\\
			\underline{\phantom{mmmmmmmmmmmmmm}} & \underline{\phantom{mmmmmmmmmmmmmm}} \\
					\groupmemberIV & \groupmemberV \\
