...
\begin{figure}[H]
	\centering
	\includegraphics[resolution=300,width=0.9\textwidth]{Flowdiagram/swipehoejretilvenstre-pil}
...
\begin{figure}[H]
	\centering
	\includegraphics[resolution=300,width=0.9\textwidth]{Flowdiagram/tommelfinger}
...
\begin{figure}[H]
	\centering
	\includegraphics[resolution=300,width=0.9\textwidth]{Flowdiagram/swipepegelangefingerhoejretilvenstre-pil}
...
\begin{figure}[H]
	\centering
	\includegraphics[resolution=300,width=0.9\textwidth]{Flowdiagram/pegelangefingerpegebue-pil}
